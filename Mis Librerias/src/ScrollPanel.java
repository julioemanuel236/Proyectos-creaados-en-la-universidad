...
/**
 * 
 * Para ajustar la distancia del borde a la 
 * que aparecen las barras de desplazamiento
 * cambiar .vsb.widthmax para la barra vertical
 * y .hsb.heightmax [ara la barra horizontal
 * 
 * @author NOBODY
 *
 */
...
public class ScrollPanel extends JLayeredPane{
	...
	protected class HSB extends JComponent{
		...
		public void __init() {
			...
			ScrollPanel.this.addMouseWheelListener(new MouseWheelListener() { 			//fuera de funcionamiento porque es horizontal solo funciona si el puntero esta encima
