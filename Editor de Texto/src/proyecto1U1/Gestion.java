...
public class Gestion {
	...
	private static File getFile() {
        ...
        // Opcion de tipo de letra
        public static void seleccionarTipoDeLetra(PrincipalGUI frame) {
            Font font = JFontChooser.showDialog(frame, "Seleccionar tipo de letra",frame.getTextArea().getFont());
            if (font != null) {
                  principalGUI.getTextArea().setFont(font);
    }
}
}