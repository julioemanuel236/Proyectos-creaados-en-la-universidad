...
public class JFontChooser extends JComponent {
    ...
    static Font showDialog(PrincipalGUI principalGUI, String seleccionar_tipo_de_letra) {
     ...
     */
     public static Font showDialog(Frame owner, String title, Font initialFont) {
        ...
        FontChooserDialog dialog = new FontChooserDialog(owner, title, fontChooser);
