 ...
 * @author morap
 */
public class ClasBuscarCancionSolic extends ClasTCanciones{
    
    @Override
    public void dificultadSeled(){
        
        
        //Eutenia
        if(cancionBuscada.equalsIgnoreCase("They Wanna Watch Me Fall")){
            
       
        System.out.println(matrisTcanciones[0][0]);
        } else if(cancionBuscada.equalsIgnoreCase("Últimas Palavras") || cancionBuscada.equalsIgnoreCase("Ultimas Palavras")){
            
        
        System.out.println(matrisTcanciones[0][1]);
        } else if(cancionBuscada.equalsIgnoreCase("Meu Fim")){
            
        
        System.out.println(matrisTcanciones[0][2]);
        } else if(cancionBuscada.equalsIgnoreCase("Carbonizar")){
            
        
        System.out.println(matrisTcanciones[0][3]);
        
        //Hellish War
        } else if(cancionBuscada.equalsIgnoreCase("Son Of The King")){
            
        
        System.out.println(matrisTcanciones[0][4]);
        } else if(cancionBuscada.equalsIgnoreCase("Metal Forever")){
        
    
        matrisTcanciones[0][5] = " Metal Forever - Hellish War     [3]";
        } else if(cancionBuscada.equalsIgnoreCase("Destroyer")){
