...
public class TextField extends JLayeredPane{
	...
	String texto="Ingrese el texto deseado";
	...
	private void Listeners() {
		...
		showhint= new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				if(TextField.this.text.getText().isEmpty()&&e.getExtendedKeyCode()!=8&&e.getKeyChar()!='?') {
					hint.setVisible(false);
				}
				
				if(TextField.this.text.getText().length()==1&&e.getExtendedKeyCode()==8) {
					TextField.this.hint.setVisible(true);	
				}
