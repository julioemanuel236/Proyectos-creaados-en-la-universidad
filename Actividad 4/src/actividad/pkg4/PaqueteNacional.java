...
public class PaqueteNacional extends Paquete implements Envio {

    private static final double FACTOR_CONVERSION = 1500.0;
    private static final double[] PRECIOS = {209.0, 235.0, 293.0, 351.0, 409.0, 467.0, 525.0, 583.0, 641.0, 699.0, 757.0};
